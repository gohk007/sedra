...
export const InspectionScalarFieldEnum = {
  ...
  dateTime: 'dateTime',
  checInspectorName: 'checInspectorName',
  ececInspectorName: 'ececInspectorName',
  villaType: 'villaType',
  villaNumber: 'villaNumber',
  activityType: 'activityType',
  statusOfInspection: 'statusOfInspection',
  remarks: 'remarks',
  department: 'department',
  wirAttachmentUrl: 'wirAttachmentUrl',
  wirAttachmentName: 'wirAttachmentName',
  userId: 'userId',
  createdAt: 'createdAt',
  updatedAt: 'updatedAt'
} as const
